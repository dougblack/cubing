...
import { a as KPuzzle, n as puzzles, t as cube2x2x2 } from "./chunk-FLK6AZKB.js";
import { t as parseSGS } from "./chunk-ROB5TROI.js";
//#region ../core/node_modules/cubing/dist/lib/cubing/chunks/search-dynamic-sgs-side-events-GB4WAJ7I.js
var cachedData = null;
...
async function megaminxKPuzzleWithoutMO() {
	const { getPuzzleGeometryByName, ExperimentalPGNotation } = await import("./puzzle-geometry.js");
	const pg = getPuzzleGeometryByName("megaminx", {
		allMoves: true,
		addRotations: true
	});
	const kpuzzle = new KPuzzle(pg.getKPuzzleDefinition(true), { experimentalPGNotation: new ExperimentalPGNotation(pg, pg.getOrbitsDef(true)) });
...
async function sgsDataPyraminxFixedOrientation() {
	return { ordering: (await sgsDataPyraminx()).ordering.slice(2) };
}
...
async function skewbKPuzzleWithoutMO() {
	...
	return new KPuzzle(pg.getKPuzzleDefinition(true), { experimentalPGNotation: new ExperimentalPGNotation(pg, pg.getOrbitsDef(true)) });
}
var defCache2 = null;
...
async function sgsDataSkewbFixedCorner() {
	return { ordering: (await sgsDataSkewb()).ordering.slice(1) };
}
...
//#endregion
export { cachedData222, cachedMegaminxKPuzzleWithoutMO, cachedSGSDataMegaminx, sgsDataPyraminx, sgsDataPyraminxFixedOrientation, sgsDataSkewb, sgsDataSkewbFixedCorner, skewbKPuzzleWithoutMOCached };
